...
GarageIOInterface.prototype.getDevice = function (callback) {
    ...
    fetch("https://garageio.com/api/controllers/v1/Sync?" + query, {
        ...
        if (data.success == true) {
            ...
            let devices = [
                {
                    "id": "7aff556c60e985545b6a1203abfb99eb",
                    "blackbox_code": "20000c2a690932d0",
                    "active": true,
                    "number_of_entities_controlled": 3,
                    "last_contact": "2019-04-27 22:26:50",
                    "software_version": "0",
                    "bluetooth_onboard": false,
                    "bluetooth_mac_address": "000000000000",
                    "registered": true,
                    "owner_first_name": "Scott",
                    "owner_last_name": "Ertle",
                    "time_before_door_open_alert": 900,
                    "doors": [
                        {
                            "id": "7722671a1414062e923f4ab01252a3df",
                            "state": "CLOSED",
                            "sensor": false,
                            "light": false,
                            "name": "Yamaha",
                            ...
                            "image": "",
                            "last_toggled": "2019-04-27 19:23:26",
                            "entity_number": 1,
                            "user_relationship": "Owner"
                        },
                        {
                            "id": "a49a875ddc83c0eaa193c2e2c8a20c7a",
                            "state": "CLOSED",
                            "sensor": false,
                            "light": false,
                            "name": "Golf Cart",
                            ...
                            "door_auto_close_delay": 0,
                            "image": "",
                            "last_toggled": "2019-04-27 22:26:50",
                            "entity_number": 2,
                            "user_relationship": "Owner"
                        }
                    ]
                ...
                {
                    "id": "5a0a09ea54c53b6cf8ddf63004dc9411",
                    "blackbox_code": "20000c2a6906cea5",
                    "active": true,
                    "number_of_entities_controlled": 3,
                    "last_contact": "2019-04-27 22:19:46",
                    "software_version": "0",
                    "bluetooth_onboard": false,
                    "bluetooth_mac_address": "000000000000",
                    "registered": true,
                    ...
                    "doors": [
                        {
                            "id": "ee4f03402e618b4c0a2fa01361995cdc",
                            "state": "CLOSED",
                            "sensor": false,
                            "light": false,
                            "name": "Tundra",
                            ...
                            "door_auto_close_delay": 0,
                            "image": "",
                            "last_toggled": "2019-04-27 19:59:40",
                            "entity_number": 1,
                            "user_relationship": "Owner"
                        },
                        {
                            "id": "cd3900cc5dabcaf4015ec3b798d44d45",
                            "state": "CLOSED",
                            "sensor": false,
                            "light": false,
                            "name": "Lisa",
                            ...
                            "door_auto_close_delay": 0,
                            "image": "",
                            "last_toggled": "2019-04-27 19:58:30",
                            "entity_number": 2,
                            "user_relationship": "Owner"
                        },
                        {
                            "id": "d1331afed77a039490dd1709d33dc180",
                            "state": "CLOSED",
                            "sensor": false,
                            "light": false,
                            "name": "Motorcycle",
                            ...
                            "door_auto_close_delay": 0,
                            "image": "",
                            "last_toggled": "2019-04-27 22:19:46",
                            "entity_number": 3,
                            "user_relationship": "Owner"
                        }
                    ]
            ...
            self.log('Garageio devices:' + JSON.stringify(devices));
            // Look through the array of hubs to get the assigned doors
            for (var k = 0; k < devices.length; k++) {
                var doors = devices[k].doors;
                ...
                for (var i = 0; i < doors.length; i++) {
                    ...
                    if (thisDoorMonitor == true) {
                        ...
                        //console.log('accessory from cache:', accessory);
